...
export async function renderSeller(root, profile, onLogout) {
  ...
  destroySeller();
  state = {root, profile, onLogout, locations:[], discounts:[], appliedDiscounts:[], stock:[], sales:[], locationId:"", cart:new Map(), lastProductId:null, paymentMethod:null, editSale:null, view:"new", unsubStock:null, keyboard:null, keyboardActive:true, saving:false, salesFilter:"today", salesLimit:100};
