const CACHE = "flor-mia-shell-v25";
const SHELL = [
  "/", "/index.html", "/styles.css?v=23", "/firebase-config.js", "/app.js?v=25",
  "/auth.js", "/admin.js?v=25", "/seller.js?v=23", "/keyboard.js", "/utils.js", "/discounts.js", "/payments.js", "/metrics.js?v=17", "/image-catalog.js",
  "/firebase-service.js?v=25", "/locations.js", "/categories.js", "/offline-sales.js", "/manifest.webmanifest", "/assets/icons/icon.svg", "/assets/img/placeholder-producto.png", "/assets/products/catalog.json",
